...
@Autonomous(name="Pos1RangeBlue", group="Exercises")
//@Disabled
public class Pos1RangeBlue extends LinearOpMode
{
	...
	public void runOpMode() throws InterruptedException
	{
		...
		Thread p2 = new Thread(){public void run(){
			if(tagOfInterest != null){
				...
				else if(tagOfInterest.id == RIGHT){moveforeward(34.5f);}
			}
			else {movebackward(20);} 
		}};
		p1.start();
		p2.start();		
	...
	private void sideCone(){
	 ...
	 private void sideConeShort1() {
		...
		Thread t8 = new Thread(){public void run(){moveforeward(13.8f); idle();}};
		Thread t0 = new Thread(){public void run(){armServo.setPosition(0.535); idle();}};
	...
	void tagToTelemetry(AprilTagDetection detection)
	{
		...
		telemetry.addLine(String.format("Translation Y: %.2f cm", detection.pose.y/100));
		telemetry.addLine(String.format("Translation Z: %.2f cm", detection.pose.z/100);
	}
}
