...
@Autonomous(name="RP2Forward", group="Exercises")
@Disabled
public class RP2forward extends LinearOpMode
{
	DcMotor leftMotor, rightMotor, backleftMotor, backrightMotor;
	TouchSensor touch;		
	BNO055IMU imu;
	Orientation	lastAngles = new Orientation();
	double globalAngle, power = .4, correction, rotation;
	...
	public void runOpMode() throws InterruptedException
	{
		...
		while (opModeIsActive())
		{
			...
			Thread t1 = new Thread(){public void run(){moveforeward(54.35f);}};
	...
	private void sideConeCap5(){
		Thread t5 = new Thread(){public void run(){rotate(-85, 0.3);}};//88
		Thread t6 = new Thread(){public void run(){armMove(0);}};
		Thread t7 = new Thread(){public void run(){moveforeward(23f);}};
		Thread t8 = new Thread(){public void run(){armSideCones5(125-(10*j));}};
		Thread t9 = new Thread(){public void run(){movebackward(23f);}};
		Thread t10 = new Thread(){public void run(){armMove(3);}};
	...
	private void sideConeCap4(){
		Thread t5 = new Thread(){public void run(){rotate(-85, 0.3);}};//91
		Thread t6 = new Thread(){public void run(){armMove(0);}};
		Thread t7 = new Thread(){public void run(){moveforeward(24f);}};
		Thread t8 = new Thread(){public void run(){armSideCones4(80-(10*j));}};
		Thread t9 = new Thread(){public void run(){movebackward(24f);}};
		Thread t10 = new Thread(){public void run(){armMove(3);}};
