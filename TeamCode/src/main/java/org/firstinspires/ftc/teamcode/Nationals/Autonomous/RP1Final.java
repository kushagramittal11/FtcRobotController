...
@Autonomous(name="RP1Final", group="Exercises")
@Disabled
public class RP1Final extends LinearOpMode
{
	...
	public void runOpMode() throws InterruptedException
	{
		...
		{		
			...
			if (signal == 0) {swayright(12);} 
			else if (signal == 1) {swayleft(36); armMove(0);} 
			else if (signal == 2) {swayleft(12); armMove(0);} 
			else if (signal == 3) {swayright(12); armMove(0);};	
			sleep(100000);
		}	
	}
