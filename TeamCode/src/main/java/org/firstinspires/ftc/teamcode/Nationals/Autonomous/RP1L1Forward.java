...
@Autonomous(name="RP1L1Forward", group="Exercises")
@Disabled
public class RP1L1Forward extends LinearOpMode
{
	...
	public void runOpMode() throws InterruptedException
	{
		...
		while (opModeIsActive())
		{
			...
			Thread t3 = new Thread(){public void run(){swayright(12);}};
			...
			if (signal == 0) { moveforeward(22);} 
			else if (signal == 1) {moveforeward(22);} 
			else if (signal == 2) {armMove(0);} 
			else if (signal == 3) {movebackward(24);};	
			sleep(100000);
		}	
	}
	...
	private void sideConeCap5(){
		...
		Thread t8 = new Thread(){public void run(){armSideCones5(122);}};
		Thread t9 = new Thread(){public void run(){movebackward(21.5f);}};
	...
	private void level_1(){
		...
		Thread t12 = new Thread(){public void run(){armSideCones5(82);}};
	...
	private void level_1_2(){
		...
		Thread t11 = new Thread(){public void run(){moveforeward(21f);}};
		Thread t12 = new Thread(){public void run(){armSideCones5(75);}};
		Thread t13 = new Thread(){public void run(){movebackward(21);}};
		Thread t14 = new Thread(){public void run(){armMove(1);}};
	...
	private void sideConeCap4(){
		...
		Thread t6 = new Thread(){public void run(){armMove(0);}};
		Thread t7 = new Thread(){public void run(){moveforeward(23f);}};
		Thread t8 = new Thread(){public void run(){armSideCones4(125);}};
