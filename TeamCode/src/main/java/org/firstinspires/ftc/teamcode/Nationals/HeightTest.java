...
@Autonomous(name="HeightTest", group="Exercises")
@Disabled
public class HeightTest extends LinearOpMode
{
	...
	public void runOpMode() throws InterruptedException
	{
		...
		{
				armSideCones5(80-(10*j));
				sleep(4000);
				armMove(0);
				armSideCones4(110-(10*j));
				sleep(4000);
				armMove(0);
				armSideCones5(120-(10*j));
				sleep(4000);
				armMove(0);
				armMove(1);
				sleep(4000);
	...
	private void sideConeCap5(){
		...
		Thread t8 = new Thread(){public void run(){armSideCones5(128-(10*j));}};
